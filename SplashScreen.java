...
public class SplashScreen {
    ...
    public void animateCompName() throws FileNotFoundException {
      ...
      translateLogo.setDuration(Duration.millis(4000));
      translateLogo.setByY(800);
      translateLogo.play();
      scene.setFill(background);
      stage.setScene(scene);
      //Fades in Presents
      FadeTransition presents = new FadeTransition(Duration.millis(7000), imageViewScreen1Text[1]);
